package foxiwhitee.FoxRecipeMaker.utils;
...
import foxiwhitee.FoxRecipeMaker.items.ReciperItemBlock;
...
public class RegisterUtils {
    public static CreativeTabs tab = FoxRecipeMaker.creativeTab;
    ...
    public static void registerBlock(Block block) {
        ...
        GameRegistry.registerBlock(block, ReciperItemBlock.class, block.getUnlocalizedName().replace("tile.", ""));
        blocks.add(block);
