...
public class NetworkManager {
    ...
    private final IHandlerPacket clientPacketHandler;
    private final IHandlerPacket serverPacketHandler;
    ...
    private static class ClientPacketProcessor implements IHandlerPacket {
        @Override
    ...
    private static class ServerPacketProcessor implements IHandlerPacket {
        @Override
        public void onPacketData(IInfoPacket network, FMLProxyPacket packet, EntityPlayer player) {
            try {
                int packetId = packet.payload().readInt();
